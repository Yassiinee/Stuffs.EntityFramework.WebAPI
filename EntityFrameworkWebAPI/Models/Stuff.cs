...
{
    public sealed class Stuff : EntityBase
    {
        ...
        private Stuff(string title, string genre, DateTimeOffset releaseDate, double rating)
        {
            Title = title;
            Genre = genre;
        ...
        public static Stuff Create(string title, string genre, DateTimeOffset releaseDate, double rating)
        {
            ValidateInputs(title, genre, releaseDate, rating);
            return new Stuff(title, genre, releaseDate, rating);
        }
